...
const FeaturedDestination = () => {
  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:-x-24 bg-slate-50 py-20'>
      ...
      <button className='my-16 px-4 py-2.5 text-sm font-medium border border-gray-300 rounded bg-white hover:bg-gray-50 transition-all cursor-pointer' onClick={()=>{navigate('/rooms');}}>
